...
class MaxMembershipHeatmapProcessorTests {
    ...
    fun init(){
        ...
        grammar.nRules.add(NRule(grammar.starSymbol, NRuleRHS(aSymbol, aSymbol), IntervalFuzzyNumber(1.0)))
        grammar.nRules.add(NRule(grammar.starSymbol, NRuleRHS(grammar.starSymbol, aSymbol), IntervalFuzzyNumber(0.5)))
        grammar.nRules.add(NRule(grammar.starSymbol, NRuleRHS(grammar.starSymbol, grammar.starSymbol), IntervalFuzzyNumber(0.1)))
